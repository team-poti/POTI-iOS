...
final class MockUserRepository: UsersInterface {
    ...
    func getYourPageInformation(userId: Int) async throws -> YourPageEntity {
        ...
        return YourPageEntity(userId: 3, nickname: "하이루", email: "hi@hihi.com", profileImageUrl: "https://media.bunjang.co.kr/product/373927945_1_1767274552_w360.jpg", ratingAvg: 4.5, activityMessage: "최근 1일 이내 활동", joinedAt: "2025년 12월 28일 가입", hasFavoriteArtist: false, recruitSummary: recruitInfo)
    }
}
